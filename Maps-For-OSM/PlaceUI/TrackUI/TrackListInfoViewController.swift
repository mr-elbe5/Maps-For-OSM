...
class TrackListInfoViewController: PopupScrollViewController {
    ...
    override func loadView() {
        ...
        stackView.addSpacer()
        stackView.addArrangedSubview(InfoHeader(key: "trackCellInfoHeader"))
        stackView.addSpacer()
        stackView.addArrangedSubview(IconInfoText(icon: "magnifyingglass", key: "trackDetailIconInfoText"))
