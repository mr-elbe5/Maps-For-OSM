...
extension NSTextField{
    ...
    @discardableResult
    public func asHeadline() -> NSTextField{
        isBezeled = false
    ...
    @discardableResult
    public func asLabel() -> NSTextField{
        isBezeled = false
        drawsBackground = false
        isEditable = false
        isSelectable = false
    ...
    @discardableResult
    public func asSmallLabel() -> NSTextField{
        isBezeled = false
        drawsBackground = false
        isEditable = false
        isSelectable = false
    ...
    @discardableResult
    public func asEditableField(text: String) -> NSTextField{
        stringValue = text
        isBezeled = true
    ...
    @discardableResult
    public func asSmallCompressable() -> NSTextField{
