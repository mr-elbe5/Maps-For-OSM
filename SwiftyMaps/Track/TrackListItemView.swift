...
class TrackListItemView : UIView{
    ...
    init(data: Track){
        ...
        trackView.addSubviewWithAnchors(durationLabel, top: downDistanceLabel.bottomAnchor, leading: trackView.leadingAnchor, bottom: trackView.bottomAnchor, insets: UIEdgeInsets(top: 0, left: defaultInset, bottom: defaultInset, right: defaultInset))
    }
