...
extension NSScrollView{
    ...
    func asVerticalScrollView(contentView: NSView, insets : NSEdgeInsets = Insets.defaultInsets){
    ...
    func asScrollView(contentView: NSView, insets : NSEdgeInsets = Insets.defaultInsets){
        self.hasVerticalScroller = true
