...
class TileSourcesViewController: PopupScrollViewController{
    ...
    override func loadView() {
        ...
        cartoUrlTemplateField.setAnchors(top: contentView.topAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, insets: defaultInsets)
        ...
        elbe5Button.setAnchors(top: cartoUrlTemplateField.bottomAnchor, leading: contentView.leadingAnchor, insets: flatInsets)
        ...
        topoUrlTemplateField.setAnchors(top: osmInfoLink.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, insets: defaultInsets)
        ...
        elbe5TopoButton.setAnchors(top: topoUrlTemplateField.bottomAnchor, leading: contentView.leadingAnchor, insets: flatInsets)
        ...
        contentView.addSubview(elbe5TopoInfoLink)
        elbe5TopoInfoLink.setAnchors(top: elbe5TopoButton.bottomAnchor, leading: contentView.leadingAnchor, insets: flatInsets)
        ...
        contentView.addSubview(openTopoButton)
        openTopoButton.setAnchors(top: elbe5TopoInfoLink.bottomAnchor, leading: contentView.leadingAnchor, insets: flatInsets)
        ...
        contentView.addSubview(openTopoInfoLink)
        openTopoInfoLink.setAnchors(top: openTopoButton.bottomAnchor, leading: contentView.leadingAnchor, insets: flatInsets)
        ...
        saveButton.setAnchors(top: openTopoInfoLink.bottomAnchor, bottom: contentView.bottomAnchor, insets: doubleInsets)
